if(!global.mute&&onGround){
    if(image_index > 11 && image_index < 12 && !audio_is_playing(footstep3))
        audio_play_sound(footstep3, 1, 0);
        
    else if(image_index > 16 && image_index < 17 && !audio_is_playing(footstep3)) 
        audio_play_sound(footstep3, 1, 0);
        
    else if(image_index > 21 && image_index < 22 && !audio_is_playing(footstep3)) 
        audio_play_sound(footstep3, 1, 0);
        
    else if(image_index > 26 && image_index < 27 && !audio_is_playing(footstep3))
         audio_play_sound(footstep3, 1, 0);
}
